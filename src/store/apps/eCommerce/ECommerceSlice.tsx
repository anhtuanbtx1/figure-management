...
// Alternative method to fetch products directly from JSON
export const fetchProductsFromJSON = () => async (dispatch: AppDispatch) => {
  try {
    const { getProductsData } = await import('@/utils/loadProductsData');
