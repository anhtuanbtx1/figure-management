...
SELECT COUNT(*) as ActiveToysCount FROM ManagementStore.dbo.Toys WHERE IsActive = 1;
...
SELECT Id, Name, IsActive FROM ManagementStore.dbo.ToyCategories WHERE IsActive = 1;

PRINT '';
PRINT '10. ðŸ“‹ Available active brands:';
SELECT Id, Name, IsActive FROM ManagementStore.dbo.ToyBrands WHERE IsActive = 1;
